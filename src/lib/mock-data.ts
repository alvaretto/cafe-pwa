...
export const MOCK_RAW_MATERIALS: RawMaterial[] = [
  ...
  {
    id: '5',
    name: 'Bolsas Kraft 1 Libra',
    description: 'Bolsas de papel kraft con válvula para café de 1 libra (454g)',
    category: 'empaque',
    unit: 'unidades',
    currentStock: 800,
    minStock: 150,
    ...
    supplier: 'Empaques del Café',
    supplierId: '3',
    lastPurchaseDate: new Date('2024-01-28'),
    location: 'Bodega B - Estante 3',
    isActive: true,
    tags: ['empaque', 'kraft', '1-libra', 'valvula', 'cafe'],
    createdAt: new Date('2023-01-15'),
    updatedAt: new Date('2024-01-28')
  },
  {
    id: '6',
    name: 'Bolsas Kraft 500g',
    description: 'Bolsas de papel kraft con válvula para café de 500 gramos',
    category: 'empaque',
    unit: 'unidades',
    currentStock: 600,
    minStock: 100,
    ...
    location: 'Bodega B - Estante 3',
    isActive: true,
    tags: ['empaque', 'kraft', '500g', 'valvula', 'cafe'],
    createdAt: new Date('2023-01-15'),
    updatedAt: new Date('2024-01-28')
  },
  {
    id: '7',
    name: 'Cajas de Cartón 12 unidades',
    description: 'Cajas de cartón corrugado para empaque de 12 bolsas de café',
    category: 'empaque',
    unit: 'unidades',
    currentStock: 200,
    minStock: 50,
    ...
    unitCost: 1200,
    totalValue: 240000,
    supplier: 'Cartones y Empaques',
    supplierId: '5',
    lastPurchaseDate: new Date('2024-01-22'),
    location: 'Bodega B - Estante 4',
    isActive: true,
    tags: ['cajas', 'carton', '12-unidades', 'empaque-secundario'],
    createdAt: new Date('2023-01-15'),
    updatedAt: new Date('2024-01-22')
  }
]
...
export const MOCK_RAW_MATERIAL_MOVEMENTS: RawMaterialMovement[] = [
  ...
  },
  {
    id: '5',
    rawMaterialId: '5',
    rawMaterialName: 'Bolsas Kraft 1 Libra',
    movementType: 'entrada',
    quantity: 1000,
    unitCost: 650,
    totalCost: 650000,
    reason: 'Compra a proveedor - Material de empaque para café 1 libra',
    documentNumber: 'FAC-2024-004',
    supplierId: '3',
    supplierName: 'Empaques del Café',
    userId: '1',
    userName: 'Administrador',
  ...
  },
  {
    ...
    unitCost: 650,
    totalCost: 130000,
    reason: 'Consumo en empaque de café tostado',
    productionOrderId: 'PROD-2024-002',
    userId: '1',
    userName: 'Administrador',
    date: new Date('2024-01-29'),
    createdAt: new Date('2024-01-29T15:20:00')
  },
  {
    id: '7',
    rawMaterialId: '6',
    rawMaterialName: 'Bolsas Kraft 500g',
    movementType: 'entrada',
    quantity: 800,
    unitCost: 580,
    totalCost: 464000,
    reason: 'Compra a proveedor - Material de empaque para café 500g',
    documentNumber: 'FAC-2024-005',
    supplierId: '3',
    supplierName: 'Empaques del Café',
    userId: '1',
    userName: 'Administrador',
  ...
  },
  {
    id: '8',
    rawMaterialId: '7',
    rawMaterialName: 'Cajas de Cartón 12 unidades',
    movementType: 'entrada',
    quantity: 250,
    unitCost: 1200,
    totalCost: 300000,
    reason: 'Compra a proveedor - Empaque secundario',
    documentNumber: 'FAC-2024-006',
    supplierId: '5',
    supplierName: 'Cartones y Empaques',
    userId: '1',
    userName: 'Administrador',
    date: new Date('2024-01-22'),
    createdAt: new Date('2024-01-22T14:15:00')
  },
  {
    ...
    unitCost: 1200,
    totalCost: 60000,
    reason: 'Consumo en empaque final de productos',
    productionOrderId: 'PROD-2024-003',
    userId: '1',
    userName: 'Administrador',
